...
def create_app():
    try:
        ...
        #
        # # DataBase Bringup
        auth_token_db_obj = CreateDbEngine(service_name=SERVICE_NAME, db_driver="mysql+pymysql", db_user="root", db_password="Ishi#06041995", db_ip_address="localhost", db_port="3305", db_name="AUTHTOKENS")
